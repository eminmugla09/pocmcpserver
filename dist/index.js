    ...
    if (body?.method === "tools/list") {
        ...
        try {
            ...
            const tools = [
                ...
                { name: "get_billing_inquiry", description: "Return current bill, due date, charge breakdown, kWh usage and EV off-peak savings. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." } }, additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "get_payment_history", description: "Return recent payment history and AutoPay scheduling details. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." } }, additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "get_usage_history", description: "Return monthly kWh, cost and EV charging kWh trend history. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." } }, additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "get_ev_enrollment", description: "Return FPL EVolution Home enrollment and charger details for an account. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." } }, additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                ...
                { name: "set_autopay", description: "Enable autopay for an account. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." }, payment_method: { type: "object" } }, additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "cancel_autopay", description: "Disable autopay for an account. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." } }, additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "update_payment_method", description: "Update stored payment method metadata for an account. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." }, method_type: { type: "string" }, last4: { type: "string" }, label: { type: "string" } }, required: ["method_type"], additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "request_payment_extension", description: "Request and apply a payment extension for the latest bill. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." }, requested_due_date: { type: "string" }, reason: { type: "string" } }, required: ["requested_due_date"], additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "get_disconnection_risk", description: "Get disconnection risk for an account based on standing and bill status. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." } }, additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "start_stop_transfer_service", description: "Create a start, stop, or transfer service order. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { action: { type: "string", enum: ["start", "stop", "transfer"] }, account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." }, from_premise: { type: "string" }, to_premise: { type: "string" }, effective_date: { type: "string" } }, required: ["action"], additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "schedule_reconnect", description: "Schedule reconnect service order for an account. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." }, reconnect_date: { type: "string" } }, required: ["reconnect_date"], additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                ...
                { name: "set_paperless_billing", description: "Enable or disable paperless billing program. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." }, enabled: { type: "boolean" } }, required: ["enabled"], additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "get_rate_plan_options", description: "Get available rate plan options for account. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." } }, additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "compare_rate_plan_savings", description: "Compare estimated savings for a candidate rate plan. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." }, candidate_rate: { type: "string" } }, required: ["candidate_rate"], additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "get_peak_alerts", description: "Get account peak usage alerts. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." } }, additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "recommend_ev_charging_window", description: "Recommend EV charging window based on account behavior. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." } }, additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "projected_next_bill", description: "Project next bill amount from recent usage. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." } }, additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
                { name: "create_support_case", description: "Create support case for an account issue. account_number is auto-resolved from your login if omitted.", inputSchema: { type: "object", properties: { account_number: { type: "string", description: "Optional. Auto-resolved from authenticated user if omitted." }, category: { type: "string" }, subject: { type: "string" }, description: { type: "string" }, priority: { type: "string", enum: ["low", "normal", "high"] } }, required: ["category", "subject", "description"], additionalProperties: false, $schema: "http://json-schema.org/draft-07/schema#" } },
